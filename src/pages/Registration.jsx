...
import { Plus, Trash2, UploadCloud, Link as LinkIcon, Send, ArrowLeft } from "lucide-react";
    ...
    <section className="page-section">
      <div className="container form-container">
        <div className="page-title">
          <h1 className="registration-choice-page-title">Đăng ký tham gia Ngày hội</h1>
          <p>
        ...
        <div className="registration-choice-grid">
          {choices.map((choice) => (
            ...
            >
              <div>
                <h2 className="registration-choice-title">{choice.title}</h2>
                <p className="registration-choice-description">{choice.description}</p>
              </div>
...
function ArtProgramForm({ submitted, setSubmitted, onBack, navigate }) {
  ...
  const updatePerformance = (index, key, value) => {
    setForm((prev) => ({
      ...prev,
      performances: prev.performances.map((p, i) =>
  ...
  const addPerformance = () => {
    setForm((prev) => ({
      ...prev,
      performances: [...prev.performances, emptyPerformance()]
    }));
  };
  ...
  const submit = (e) => {
    ...
    const submissions = form.performances.map((p, index) => ({
      ...
      registrationType: REGISTRATION_TYPES.ART,
      ...p,
      unit: form.unit,
      ...
      budgetFileName: form.budgetFile?.name || "",
      status: "pending",
      ...
      <section className="page-section">
        <div className="container narrow">
          <div className="success-card">
            ...
            <p>
              Thông tin đã được lưu ở chế độ local để bạn kiểm tra flow. Khi tích
              hợp Google Sheets/Drive, dữ liệu sẽ được gửi về hệ thống thật.
            </p>
            <div className="success-actions">
              <button
                className="btn btn-primary"
                onClick={() => navigate("/cac-tiet-muc")}
              >
  ...
  return (
    <section className="page-section">
      <div className="container form-container">
        ...
        <div className="page-title">
          <span className="eyebrow">01 · CHƯƠNG TRÌNH NGHỆ THUẬT</span>
          <h1>Đăng ký chương trình nghệ thuật</h1>
          <p>
            Vui lòng cung cấp đầy đủ thông tin để Ban Tổ chức tổng hợp và bố trí
            chương trình.
          </p>
        </div>
        ...
        <form className="registration-form" onSubmit={submit}>
          ...
          <div className="form-section">
            <div className="form-section-title">
              <span>02</span>
              <div>
                <h2>Thông tin chương trình nghệ thuật</h2>
                <p>Mỗi tiết mục được nhập theo thứ tự biểu diễn.</p>
              </div>
            </div>
            ...
            {form.performances.map((performance, index) => (
              <div className="performance-form-card" key={index}>
                <div className="performance-form-head">
                  <div>
                    <strong>Tiết mục {index + 1}</strong>
                    <span>Thứ tự biểu diễn</span>
                  </div>
                  {form.performances.length > 1 && (
                    <button
                      type="button"
                ...
                <div className="form-grid">
                  <label className="field full">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updatePerformance(index, "title", e.target.value)
                      }
                  ...
                  <label className="field full">
                    <span>
                      Quốc gia / nền văn hóa đại diện <b>*</b>
                    </span>
                    <textarea
                      value={performance.culture}
                      onChange={(e) =>
                        updatePerformance(index, "culture", e.target.value)
                      }
                  ...
                  <label className="field full">
                    ...
                    <textarea
                      value={performance.meaning}
                      onChange={(e) =>
                        updatePerformance(index, "meaning", e.target.value)
                      }
                  ...
                  <label className="field">
                    ...
                    <input
                      type="number"
                      min="1"
                      value={performance.people}
                      onChange={(e) =>
                        updatePerformance(index, "people", e.target.value)
                      }
                  ...
                  <label className="field">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updatePerformance(index, "duration", e.target.value)
                      }
                      placeholder="Ví dụ: 5"
                      required
                    />
                  ...
                  <label className="field">
                    <span>
                      <LinkIcon size={15} /> Link video demo <b>*</b>
                    </span>
                    <input
                      type="url"
                      value={performance.demoVideo}
                      onChange={(e) =>
                        updatePerformance(index, "demoVideo", e.target.value)
                      }
                      placeholder="https://..."
                      required
                    />
                  ...
                  <label className="field">
                    <span>
                      <LinkIcon size={15} /> Link nhạc nền <b>*</b>
                    </span>
                    <input
                      type="url"
                      value={performance.backgroundMusic}
                      onChange={(e) =>
                        updatePerformance(index, "backgroundMusic", e.target.value)
                      }
                      placeholder="https://..."
                      required
                    />
                  ...
                  <label className="field full">
                    ...
                    <textarea
                      value={performance.technical}
                      onChange={(e) =>
                        updatePerformance(index, "technical", e.target.value)
                      }
          ...
          <div className="form-section">
            <div className="form-section-title">
              <span>03</span>
              <div>
                <h2>Danh sách tham gia &amp; Dự trù kinh phí</h2>
                <p>
                  Vui lòng upload đầy đủ danh sách thành viên và file dự trù
                  kinh phí.
                </p>
              </div>
            </div>
            ...
            <div className="form-grid">
              <label className="upload-box">
                <input
                  ...
                  onChange={(e) =>
                    update("participantFile", e.target.files?.[0] || null)
                  }
                  required
                />
                <UploadCloud size={27} />
              ...
              <label className="upload-box">
                <input
                  ...
                  accept=".xlsx,.xls,.doc,.docx,.pdf,.csv"
                  onChange={(e) =>
                    update("budgetFile", e.target.files?.[0] || null)
                  }
                  required
                />
                <UploadCloud size={27} />
            ...
            <label className="commitment-confirmation">
              <input
                type="checkbox"
                checked={form.commitment === "Đồng ý xác nhận"}
                onChange={(e) =>
                  update(
                    "commitment",
                    e.target.checked ? "Đồng ý xác nhận" : ""
                  )
                }
                required
              />
              <span>
                Tôi xác nhận các thông tin đã cung cấp là đầy đủ, chính xác và
                cam kết tham gia chương trình theo nội dung đăng ký. <b>*</b>
              </span>
            </label>
          </div>
...
function ExhibitionForm({ submitted, setSubmitted, onBack }) {
  const [form, setForm] = useState({
    unit: "",
    content: "",
    completionTime: "",
  ...
  const submit = (e) => {
    ...
    addSubmission({
      id: `local-exhibition-${Date.now()}`,
      registrationType: REGISTRATION_TYPES.EXHIBITION,
      unit: form.unit,
      exhibitionContent: form.content,
  ...
  if (submitted) {
    return <SimpleSuccess title="Đăng ký gian hàng triển lãm thành công" onBack={onBack} />;
  }
  ...
  return (
    <section className="page-section">
      <div className="container form-container">
        ...
        <div className="page-title">
          <span className="eyebrow">02 · GIAN HÀNG TRIỂN LÃM</span>
          <h1>Đăng ký gian hàng triển lãm</h1>
          <p>
            Cung cấp thông tin để Ban Tổ chức tổng hợp nội dung và hỗ trợ bố trí
            gian hàng.
          </p>
        </div>
          ...
          <div className="form-section">
            <div className="form-section-title">
              ...
              <div>
                ...
                <p>Thông tin cơ bản của nội dung triển lãm.</p>
              </div>
            </div>
            ...
            <div className="form-grid">
              ...
              <label className="field">
                <span>Thời gian hoàn thiện <b>*</b></span>
                <input
              ...
              <label className="field full">
                <span>Nhân sự phụ trách - SĐT <b>*</b></span>
                <input
                  value={form.contact}
                  onChange={(e) => update("contact", e.target.value)}
              ...
              <label className="field full">
                <span>Nội dung triển lãm <b>*</b></span>
                <textarea
                  value={form.content}
              ...
              <label className="field full">
                <span>Bố cục trang trí (nếu có)</span>
                <textarea
                  value={form.layout}
          ...
          <div className="form-section">
            <div className="form-section-title">
              ...
              <div>
                ...
                <p>Xác nhận thông tin trước khi gửi đăng ký.</p>
              </div>
            </div>
            ...
            <CommitmentConfirmation
              checked={form.commitment === "Đồng ý xác nhận"}
              onChange={(checked) =>
                update("commitment", checked ? "Đồng ý xác nhận" : "")
              }
            />
          </div>
...
function UnitActivityForm({ submitted, setSubmitted, onBack }) {
  const [form, setForm] = useState({
    unit: "",
    contact: "",
    commitment: "",
  ...
  const canSubmit = useMemo(
    () =>
      ...
      form.contact &&
      form.commitment &&
      form.activities.every((activity) => activity.name && activity.content),
    [form]
  );
  ...
  if (submitted) {
    return <SimpleSuccess title="Đăng ký hoạt động của đơn vị thành công" onBack={onBack} />;
  }
  ...
  return (
    <section className="page-section">
      <div className="container form-container">
        ...
        <div className="page-title">
          <span className="eyebrow">03 · HOẠT ĐỘNG CỦA ĐƠN VỊ</span>
          <h1>Đăng ký hoạt động của đơn vị</h1>
          <p>
            Đăng ký các hoạt động dự kiến thực hiện trong khuôn khổ Ngày hội.
          </p>
        </div>
          ...
          <div className="form-section">
            <div className="form-section-title">
              ...
              <div>
                ...
                <p>Có thể đăng ký nhiều hoạt động của cùng một đơn vị.</p>
              </div>
            </div>
            ...
            {form.activities.map((activity, index) => (
              <div className="performance-form-card" key={index}>
                <div className="performance-form-head">
                  <div>
                    <strong>Hoạt động {index + 1}</strong>
                ...
                <div className="form-grid">
                  ...
                  <label className="field full">
                    <span>Nội dung thực hiện <b>*</b></span>
                    <textarea
...
function CommitmentConfirmation({ checked, onChange }) {
  return (
    <label className="commitment-confirmation">
      <input
        type="checkbox"
      ...
      />
      <span>
        Tôi xác nhận các thông tin đã cung cấp là đầy đủ, chính xác và cam kết
        tham gia chương trình theo nội dung đăng ký. <b>*</b>
      </span>
    </label>
  );
}
...
function SimpleSuccess({ title, onBack }) {
  return (
    <section className="page-section">
      <div className="container narrow">
        <div className="success-card">
...
export default function Registration() {
  ...
  if (!selectedType) {
    return <RegistrationChoice onSelect={setSelectedType} />;
  }
